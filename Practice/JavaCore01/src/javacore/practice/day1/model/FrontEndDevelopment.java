package javacore.practice.day1.model;

import javacore.practice.day1.model.Employee;
...
public class FrontEndDevelopment extends Employee {
    ...
    public FrontEndDevelopment(int id, String name, String frameworkName, String language, String programmingLangue) {
        super(id, name);
